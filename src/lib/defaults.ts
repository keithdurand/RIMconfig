...
export const DEFAULTS = {
  ...
  crown: {
    ...
    z: { value: -1.99, min: -10, max: 10, step: 0.01 },
  },
  outer: {
  ...
  externalBiarc: {
    // Offsets from the outer-rim spline endpoint to the body-side endpoint.
    dx: { value: -2.65, min: -6, max: -0.1, step: 0.01 },
    dz: { value: -5.3, min: -12, max: -0.1, step: 0.01 },
  ...
  internalJunction: {
    ...
    endAngle: { value: 8, min: -20, max: 45, step: 0.1 },
  },
} as const;
